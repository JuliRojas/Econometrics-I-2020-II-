...
# Bases de datos ----------------------------------------------------------
CaracterísticasGenerales <- read_delim(here('input', 'Area_Caracteristicas_Generales_Personas.csv'), 
                                       ';', escape_double = FALSE, trim_ws = TRUE)
CaracterísticasOcupados <- read_delim(here('input', 'Area_Ocupados.csv'), 
                                      ';', escape_double = FALSE, trim_ws = TRUE)
